...
|----|------|--------|----------|--------|--------|
| TASK-001 | Initialize Next.js 14 project with TypeScript | NOT_STARTED | P0 | M | `task/001-nextjs-setup` |
| TASK-002 | Configure Docker + PostgreSQL for local dev | NOT_STARTED | P0 | M | `task/002-docker-postgres` |
