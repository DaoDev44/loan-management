...
export const LoanScalarFieldEnumSchema = z.enum(['id','borrowerName','borrowerEmail','borrowerPhone','principal','interestRate','startDate','endDate','termMonths','interestCalculationType','paymentFrequency','status','balance','notes','collateral','deletedAt','createdAt','updatedAt']);

export const PaymentScalarFieldEnumSchema = z.enum(['id','amount','date','notes','deletedAt','loanId','createdAt']);
...
export const LoanSchema = z.object({
  ...
  principal: z.instanceof(Prisma.Decimal, { message: "Field 'principal' must be a Decimal. Location: ['Models', 'Loan']"}),
  interestRate: z.number(),
  startDate: z.coerce.date(),
  endDate: z.coerce.date(),
  termMonths: z.number().int(),
  balance: z.instanceof(Prisma.Decimal, { message: "Field 'balance' must be a Decimal. Location: ['Models', 'Loan']"}),
...
export const LoanIncludeSchema: z.ZodType<Prisma.LoanInclude> = z.object({
...
export const LoanArgsSchema: z.ZodType<Prisma.LoanDefaultArgs> = z.object({
  select: z.lazy(() => LoanSelectSchema).optional(),
  include: z.lazy(() => LoanIncludeSchema).optional(),
}).strict();

export const LoanCountOutputTypeArgsSchema: z.ZodType<Prisma.LoanCountOutputTypeDefaultArgs> = z.object({
  select: z.lazy(() => LoanCountOutputTypeSelectSchema).nullish(),
}).strict();

export const LoanCountOutputTypeSelectSchema: z.ZodType<Prisma.LoanCountOutputTypeSelect> = z.object({
  payments: z.boolean().optional(),
}).strict();

export const LoanSelectSchema: z.ZodType<Prisma.LoanSelect> = z.object({
...
export const LoanWhereInputSchema: z.ZodType<Prisma.LoanWhereInput> = z.strictObject({
  AND: z.union([ z.lazy(() => LoanWhereInputSchema), z.lazy(() => LoanWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LoanWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LoanWhereInputSchema), z.lazy(() => LoanWhereInputSchema).array() ]).optional(),
  ...
  borrowerPhone: z.union([ z.lazy(() => StringNullableFilterSchema), z.string() ]).optional().nullable(),
  principal: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  ...
  interestCalculationType: z.union([ z.lazy(() => EnumInterestCalculationTypeFilterSchema), z.lazy(() => InterestCalculationTypeSchema) ]).optional(),
  paymentFrequency: z.union([ z.lazy(() => EnumPaymentFrequencyFilterSchema), z.lazy(() => PaymentFrequencySchema) ]).optional(),
  status: z.union([ z.lazy(() => EnumLoanStatusFilterSchema), z.lazy(() => LoanStatusSchema) ]).optional(),
  balance: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  notes: z.union([ z.lazy(() => StringNullableFilterSchema), z.string() ]).optional().nullable(),
  collateral: z.union([ z.lazy(() => StringNullableFilterSchema), z.string() ]).optional().nullable(),
...
export const LoanOrderByWithRelationInputSchema: z.ZodType<Prisma.LoanOrderByWithRelationInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  borrowerName: z.lazy(() => SortOrderSchema).optional(),
  borrowerEmail: z.lazy(() => SortOrderSchema).optional(),
  borrowerPhone: z.union([ z.lazy(() => SortOrderSchema), z.lazy(() => SortOrderInputSchema) ]).optional(),
  ...
  collateral: z.union([ z.lazy(() => SortOrderSchema), z.lazy(() => SortOrderInputSchema) ]).optional(),
...
export const LoanWhereUniqueInputSchema: z.ZodType<Prisma.LoanWhereUniqueInput> = z.object({
  id: z.cuid(),
})
.and(z.strictObject({
  id: z.cuid().optional(),
...
export const LoanOrderByWithAggregationInputSchema: z.ZodType<Prisma.LoanOrderByWithAggregationInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  borrowerName: z.lazy(() => SortOrderSchema).optional(),
  borrowerEmail: z.lazy(() => SortOrderSchema).optional(),
  borrowerPhone: z.union([ z.lazy(() => SortOrderSchema), z.lazy(() => SortOrderInputSchema) ]).optional(),
...
export const LoanScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LoanScalarWhereWithAggregatesInput> = z.strictObject({
  AND: z.union([ z.lazy(() => LoanScalarWhereWithAggregatesInputSchema), z.lazy(() => LoanScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => LoanScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LoanScalarWhereWithAggregatesInputSchema), z.lazy(() => LoanScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  borrowerPhone: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema), z.string() ]).optional().nullable(),
  principal: z.union([ z.lazy(() => DecimalWithAggregatesFilterSchema), z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  ...
  interestCalculationType: z.union([ z.lazy(() => EnumInterestCalculationTypeWithAggregatesFilterSchema), z.lazy(() => InterestCalculationTypeSchema) ]).optional(),
  paymentFrequency: z.union([ z.lazy(() => EnumPaymentFrequencyWithAggregatesFilterSchema), z.lazy(() => PaymentFrequencySchema) ]).optional(),
  status: z.union([ z.lazy(() => EnumLoanStatusWithAggregatesFilterSchema), z.lazy(() => LoanStatusSchema) ]).optional(),
  balance: z.union([ z.lazy(() => DecimalWithAggregatesFilterSchema), z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  notes: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema), z.string() ]).optional().nullable(),
  collateral: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema), z.string() ]).optional().nullable(),
...
export const PaymentWhereInputSchema: z.ZodType<Prisma.PaymentWhereInput> = z.strictObject({
  ...
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema), z.coerce.date() ]).optional(),
  loan: z.union([ z.lazy(() => LoanScalarRelationFilterSchema), z.lazy(() => LoanWhereInputSchema) ]).optional(),
});
...
export const LoanCreateInputSchema: z.ZodType<Prisma.LoanCreateInput> = z.strictObject({
  ...
  principal: z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
  interestRate: z.number(),
  startDate: z.coerce.date(),
  endDate: z.coerce.date(),
  termMonths: z.number().int(),
  ...
  balance: z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
...
export const LoanUncheckedCreateInputSchema: z.ZodType<Prisma.LoanUncheckedCreateInput> = z.strictObject({
  id: z.cuid().optional(),
  borrowerName: z.string(),
  borrowerEmail: z.string(),
  borrowerPhone: z.string().optional().nullable(),
...
export const LoanUpdateInputSchema: z.ZodType<Prisma.LoanUpdateInput> = z.strictObject({
  ...
  borrowerName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerEmail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerPhone: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  principal: z.union([ z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  termMonths: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  interestCalculationType: z.union([ z.lazy(() => InterestCalculationTypeSchema), z.lazy(() => EnumInterestCalculationTypeFieldUpdateOperationsInputSchema) ]).optional(),
  paymentFrequency: z.union([ z.lazy(() => PaymentFrequencySchema), z.lazy(() => EnumPaymentFrequencyFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.lazy(() => LoanStatusSchema), z.lazy(() => EnumLoanStatusFieldUpdateOperationsInputSchema) ]).optional(),
  balance: z.union([ z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  notes: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  collateral: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const LoanUncheckedUpdateInputSchema: z.ZodType<Prisma.LoanUncheckedUpdateInput> = z.strictObject({
  id: z.union([ z.cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerEmail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerPhone: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const LoanUpdateManyMutationInputSchema: z.ZodType<Prisma.LoanUpdateManyMutationInput> = z.strictObject({
  id: z.union([ z.cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerEmail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerPhone: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const LoanUncheckedUpdateManyInputSchema: z.ZodType<Prisma.LoanUncheckedUpdateManyInput> = z.strictObject({
  id: z.union([ z.cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerEmail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerPhone: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const EnumInterestCalculationTypeFilterSchema: z.ZodType<Prisma.EnumInterestCalculationTypeFilter> = z.strictObject({
  equals: z.lazy(() => InterestCalculationTypeSchema).optional(),
  in: z.lazy(() => InterestCalculationTypeSchema).array().optional(),
  notIn: z.lazy(() => InterestCalculationTypeSchema).array().optional(),
  not: z.union([ z.lazy(() => InterestCalculationTypeSchema), z.lazy(() => NestedEnumInterestCalculationTypeFilterSchema) ]).optional(),
});

export const EnumPaymentFrequencyFilterSchema: z.ZodType<Prisma.EnumPaymentFrequencyFilter> = z.strictObject({
  equals: z.lazy(() => PaymentFrequencySchema).optional(),
  in: z.lazy(() => PaymentFrequencySchema).array().optional(),
  notIn: z.lazy(() => PaymentFrequencySchema).array().optional(),
  not: z.union([ z.lazy(() => PaymentFrequencySchema), z.lazy(() => NestedEnumPaymentFrequencyFilterSchema) ]).optional(),
});
...
export const LoanCountOrderByAggregateInputSchema: z.ZodType<Prisma.LoanCountOrderByAggregateInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  borrowerName: z.lazy(() => SortOrderSchema).optional(),
  borrowerEmail: z.lazy(() => SortOrderSchema).optional(),
...
export const LoanAvgOrderByAggregateInputSchema: z.ZodType<Prisma.LoanAvgOrderByAggregateInput> = z.strictObject({
  principal: z.lazy(() => SortOrderSchema).optional(),
  interestRate: z.lazy(() => SortOrderSchema).optional(),
  termMonths: z.lazy(() => SortOrderSchema).optional(),
  balance: z.lazy(() => SortOrderSchema).optional(),
...
export const LoanMaxOrderByAggregateInputSchema: z.ZodType<Prisma.LoanMaxOrderByAggregateInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  borrowerName: z.lazy(() => SortOrderSchema).optional(),
  borrowerEmail: z.lazy(() => SortOrderSchema).optional(),
  borrowerPhone: z.lazy(() => SortOrderSchema).optional(),
...
export const LoanMinOrderByAggregateInputSchema: z.ZodType<Prisma.LoanMinOrderByAggregateInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  borrowerName: z.lazy(() => SortOrderSchema).optional(),
  borrowerEmail: z.lazy(() => SortOrderSchema).optional(),
  borrowerPhone: z.lazy(() => SortOrderSchema).optional(),
...
export const LoanSumOrderByAggregateInputSchema: z.ZodType<Prisma.LoanSumOrderByAggregateInput> = z.strictObject({
  principal: z.lazy(() => SortOrderSchema).optional(),
  interestRate: z.lazy(() => SortOrderSchema).optional(),
  termMonths: z.lazy(() => SortOrderSchema).optional(),
  balance: z.lazy(() => SortOrderSchema).optional(),
...
export const EnumInterestCalculationTypeWithAggregatesFilterSchema: z.ZodType<Prisma.EnumInterestCalculationTypeWithAggregatesFilter> = z.strictObject({
  equals: z.lazy(() => InterestCalculationTypeSchema).optional(),
  in: z.lazy(() => InterestCalculationTypeSchema).array().optional(),
  notIn: z.lazy(() => InterestCalculationTypeSchema).array().optional(),
  not: z.union([ z.lazy(() => InterestCalculationTypeSchema), z.lazy(() => NestedEnumInterestCalculationTypeWithAggregatesFilterSchema) ]).optional(),
  _count: z.lazy(() => NestedIntFilterSchema).optional(),
...
export const EnumPaymentFrequencyWithAggregatesFilterSchema: z.ZodType<Prisma.EnumPaymentFrequencyWithAggregatesFilter> = z.strictObject({
  equals: z.lazy(() => PaymentFrequencySchema).optional(),
  in: z.lazy(() => PaymentFrequencySchema).array().optional(),
  notIn: z.lazy(() => PaymentFrequencySchema).array().optional(),
  not: z.union([ z.lazy(() => PaymentFrequencySchema), z.lazy(() => NestedEnumPaymentFrequencyWithAggregatesFilterSchema) ]).optional(),
  _count: z.lazy(() => NestedIntFilterSchema).optional(),
  _min: z.lazy(() => NestedEnumPaymentFrequencyFilterSchema).optional(),
  _max: z.lazy(() => NestedEnumPaymentFrequencyFilterSchema).optional(),
});

export const EnumLoanStatusWithAggregatesFilterSchema: z.ZodType<Prisma.EnumLoanStatusWithAggregatesFilter> = z.strictObject({
  equals: z.lazy(() => LoanStatusSchema).optional(),
  in: z.lazy(() => LoanStatusSchema).array().optional(),
  notIn: z.lazy(() => LoanStatusSchema).array().optional(),
...
export const LoanScalarRelationFilterSchema: z.ZodType<Prisma.LoanScalarRelationFilter> = z.strictObject({
...
export const PaymentCreateNestedManyWithoutLoanInputSchema: z.ZodType<Prisma.PaymentCreateNestedManyWithoutLoanInput> = z.strictObject({
  create: z.union([ z.lazy(() => PaymentCreateWithoutLoanInputSchema), z.lazy(() => PaymentCreateWithoutLoanInputSchema).array(), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => PaymentCreateOrConnectWithoutLoanInputSchema), z.lazy(() => PaymentCreateOrConnectWithoutLoanInputSchema).array() ]).optional(),
...
export const PaymentUncheckedCreateNestedManyWithoutLoanInputSchema: z.ZodType<Prisma.PaymentUncheckedCreateNestedManyWithoutLoanInput> = z.strictObject({
  create: z.union([ z.lazy(() => PaymentCreateWithoutLoanInputSchema), z.lazy(() => PaymentCreateWithoutLoanInputSchema).array(), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => PaymentCreateOrConnectWithoutLoanInputSchema), z.lazy(() => PaymentCreateOrConnectWithoutLoanInputSchema).array() ]).optional(),
  createMany: z.lazy(() => PaymentCreateManyLoanInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => PaymentWhereUniqueInputSchema), z.lazy(() => PaymentWhereUniqueInputSchema).array() ]).optional(),
...
export const EnumInterestCalculationTypeFieldUpdateOperationsInputSchema: z.ZodType<Prisma.EnumInterestCalculationTypeFieldUpdateOperationsInput> = z.strictObject({
  set: z.lazy(() => InterestCalculationTypeSchema).optional(),
});

export const EnumPaymentFrequencyFieldUpdateOperationsInputSchema: z.ZodType<Prisma.EnumPaymentFrequencyFieldUpdateOperationsInput> = z.strictObject({
  set: z.lazy(() => PaymentFrequencySchema).optional(),
});

export const EnumLoanStatusFieldUpdateOperationsInputSchema: z.ZodType<Prisma.EnumLoanStatusFieldUpdateOperationsInput> = z.strictObject({
...
export const PaymentUpdateManyWithoutLoanNestedInputSchema: z.ZodType<Prisma.PaymentUpdateManyWithoutLoanNestedInput> = z.strictObject({
  create: z.union([ z.lazy(() => PaymentCreateWithoutLoanInputSchema), z.lazy(() => PaymentCreateWithoutLoanInputSchema).array(), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => PaymentCreateOrConnectWithoutLoanInputSchema), z.lazy(() => PaymentCreateOrConnectWithoutLoanInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => PaymentUpsertWithWhereUniqueWithoutLoanInputSchema), z.lazy(() => PaymentUpsertWithWhereUniqueWithoutLoanInputSchema).array() ]).optional(),
  createMany: z.lazy(() => PaymentCreateManyLoanInputEnvelopeSchema).optional(),
  ...
  connect: z.union([ z.lazy(() => PaymentWhereUniqueInputSchema), z.lazy(() => PaymentWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => PaymentUpdateWithWhereUniqueWithoutLoanInputSchema), z.lazy(() => PaymentUpdateWithWhereUniqueWithoutLoanInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => PaymentUpdateManyWithWhereWithoutLoanInputSchema), z.lazy(() => PaymentUpdateManyWithWhereWithoutLoanInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => PaymentScalarWhereInputSchema), z.lazy(() => PaymentScalarWhereInputSchema).array() ]).optional(),
});

export const PaymentUncheckedUpdateManyWithoutLoanNestedInputSchema: z.ZodType<Prisma.PaymentUncheckedUpdateManyWithoutLoanNestedInput> = z.strictObject({
  create: z.union([ z.lazy(() => PaymentCreateWithoutLoanInputSchema), z.lazy(() => PaymentCreateWithoutLoanInputSchema).array(), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => PaymentCreateOrConnectWithoutLoanInputSchema), z.lazy(() => PaymentCreateOrConnectWithoutLoanInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => PaymentUpsertWithWhereUniqueWithoutLoanInputSchema), z.lazy(() => PaymentUpsertWithWhereUniqueWithoutLoanInputSchema).array() ]).optional(),
  createMany: z.lazy(() => PaymentCreateManyLoanInputEnvelopeSchema).optional(),
...
export const LoanCreateNestedOneWithoutPaymentsInputSchema: z.ZodType<Prisma.LoanCreateNestedOneWithoutPaymentsInput> = z.strictObject({
  create: z.union([ z.lazy(() => LoanCreateWithoutPaymentsInputSchema), z.lazy(() => LoanUncheckedCreateWithoutPaymentsInputSchema) ]).optional(),
...
export const LoanUpdateOneRequiredWithoutPaymentsNestedInputSchema: z.ZodType<Prisma.LoanUpdateOneRequiredWithoutPaymentsNestedInput> = z.strictObject({
  create: z.union([ z.lazy(() => LoanCreateWithoutPaymentsInputSchema), z.lazy(() => LoanUncheckedCreateWithoutPaymentsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => LoanCreateOrConnectWithoutPaymentsInputSchema).optional(),
  upsert: z.lazy(() => LoanUpsertWithoutPaymentsInputSchema).optional(),
  connect: z.lazy(() => LoanWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => LoanUpdateToOneWithWhereWithoutPaymentsInputSchema), z.lazy(() => LoanUpdateWithoutPaymentsInputSchema), z.lazy(() => LoanUncheckedUpdateWithoutPaymentsInputSchema) ]).optional(),
});
...
export const NestedEnumInterestCalculationTypeFilterSchema: z.ZodType<Prisma.NestedEnumInterestCalculationTypeFilter> = z.strictObject({
  equals: z.lazy(() => InterestCalculationTypeSchema).optional(),
  in: z.lazy(() => InterestCalculationTypeSchema).array().optional(),
  notIn: z.lazy(() => InterestCalculationTypeSchema).array().optional(),
  not: z.union([ z.lazy(() => InterestCalculationTypeSchema), z.lazy(() => NestedEnumInterestCalculationTypeFilterSchema) ]).optional(),
...
export const NestedEnumPaymentFrequencyFilterSchema: z.ZodType<Prisma.NestedEnumPaymentFrequencyFilter> = z.strictObject({
  equals: z.lazy(() => PaymentFrequencySchema).optional(),
  in: z.lazy(() => PaymentFrequencySchema).array().optional(),
  notIn: z.lazy(() => PaymentFrequencySchema).array().optional(),
  not: z.union([ z.lazy(() => PaymentFrequencySchema), z.lazy(() => NestedEnumPaymentFrequencyFilterSchema) ]).optional(),
...
export const NestedEnumLoanStatusFilterSchema: z.ZodType<Prisma.NestedEnumLoanStatusFilter> = z.strictObject({
  equals: z.lazy(() => LoanStatusSchema).optional(),
  in: z.lazy(() => LoanStatusSchema).array().optional(),
  notIn: z.lazy(() => LoanStatusSchema).array().optional(),
  not: z.union([ z.lazy(() => LoanStatusSchema), z.lazy(() => NestedEnumLoanStatusFilterSchema) ]).optional(),
...
export const NestedEnumInterestCalculationTypeWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumInterestCalculationTypeWithAggregatesFilter> = z.strictObject({
  equals: z.lazy(() => InterestCalculationTypeSchema).optional(),
  in: z.lazy(() => InterestCalculationTypeSchema).array().optional(),
  notIn: z.lazy(() => InterestCalculationTypeSchema).array().optional(),
  not: z.union([ z.lazy(() => InterestCalculationTypeSchema), z.lazy(() => NestedEnumInterestCalculationTypeWithAggregatesFilterSchema) ]).optional(),
...
export const NestedEnumPaymentFrequencyWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumPaymentFrequencyWithAggregatesFilter> = z.strictObject({
  equals: z.lazy(() => PaymentFrequencySchema).optional(),
  in: z.lazy(() => PaymentFrequencySchema).array().optional(),
  notIn: z.lazy(() => PaymentFrequencySchema).array().optional(),
  not: z.union([ z.lazy(() => PaymentFrequencySchema), z.lazy(() => NestedEnumPaymentFrequencyWithAggregatesFilterSchema) ]).optional(),
...
export const NestedEnumLoanStatusWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumLoanStatusWithAggregatesFilter> = z.strictObject({
  equals: z.lazy(() => LoanStatusSchema).optional(),
  in: z.lazy(() => LoanStatusSchema).array().optional(),
  notIn: z.lazy(() => LoanStatusSchema).array().optional(),
  not: z.union([ z.lazy(() => LoanStatusSchema), z.lazy(() => NestedEnumLoanStatusWithAggregatesFilterSchema) ]).optional(),
...
export const PaymentCreateWithoutLoanInputSchema: z.ZodType<Prisma.PaymentCreateWithoutLoanInput> = z.strictObject({
  id: z.cuid().optional(),
  amount: z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
  date: z.coerce.date().optional(),
  notes: z.string().optional().nullable(),
...
export const PaymentUncheckedCreateWithoutLoanInputSchema: z.ZodType<Prisma.PaymentUncheckedCreateWithoutLoanInput> = z.strictObject({
  id: z.cuid().optional(),
  amount: z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
  date: z.coerce.date().optional(),
  notes: z.string().optional().nullable(),
...
export const PaymentCreateOrConnectWithoutLoanInputSchema: z.ZodType<Prisma.PaymentCreateOrConnectWithoutLoanInput> = z.strictObject({
  where: z.lazy(() => PaymentWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => PaymentCreateWithoutLoanInputSchema), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema) ]),
});

export const PaymentCreateManyLoanInputEnvelopeSchema: z.ZodType<Prisma.PaymentCreateManyLoanInputEnvelope> = z.strictObject({
  data: z.union([ z.lazy(() => PaymentCreateManyLoanInputSchema), z.lazy(() => PaymentCreateManyLoanInputSchema).array() ]),
  skipDuplicates: z.boolean().optional(),
});

export const PaymentUpsertWithWhereUniqueWithoutLoanInputSchema: z.ZodType<Prisma.PaymentUpsertWithWhereUniqueWithoutLoanInput> = z.strictObject({
  where: z.lazy(() => PaymentWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => PaymentUpdateWithoutLoanInputSchema), z.lazy(() => PaymentUncheckedUpdateWithoutLoanInputSchema) ]),
  create: z.union([ z.lazy(() => PaymentCreateWithoutLoanInputSchema), z.lazy(() => PaymentUncheckedCreateWithoutLoanInputSchema) ]),
});

export const PaymentUpdateWithWhereUniqueWithoutLoanInputSchema: z.ZodType<Prisma.PaymentUpdateWithWhereUniqueWithoutLoanInput> = z.strictObject({
  where: z.lazy(() => PaymentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => PaymentUpdateWithoutLoanInputSchema), z.lazy(() => PaymentUncheckedUpdateWithoutLoanInputSchema) ]),
});

export const PaymentUpdateManyWithWhereWithoutLoanInputSchema: z.ZodType<Prisma.PaymentUpdateManyWithWhereWithoutLoanInput> = z.strictObject({
  where: z.lazy(() => PaymentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => PaymentUpdateManyMutationInputSchema), z.lazy(() => PaymentUncheckedUpdateManyWithoutLoanInputSchema) ]),
});
...
export const LoanCreateWithoutPaymentsInputSchema: z.ZodType<Prisma.LoanCreateWithoutPaymentsInput> = z.strictObject({
  id: z.cuid().optional(),
  borrowerName: z.string(),
  borrowerEmail: z.string(),
  borrowerPhone: z.string().optional().nullable(),
...
export const LoanUncheckedCreateWithoutPaymentsInputSchema: z.ZodType<Prisma.LoanUncheckedCreateWithoutPaymentsInput> = z.strictObject({
  id: z.cuid().optional(),
  borrowerName: z.string(),
  borrowerEmail: z.string(),
  borrowerPhone: z.string().optional().nullable(),
...
export const LoanCreateOrConnectWithoutPaymentsInputSchema: z.ZodType<Prisma.LoanCreateOrConnectWithoutPaymentsInput> = z.strictObject({
  where: z.lazy(() => LoanWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => LoanCreateWithoutPaymentsInputSchema), z.lazy(() => LoanUncheckedCreateWithoutPaymentsInputSchema) ]),
});

export const LoanUpsertWithoutPaymentsInputSchema: z.ZodType<Prisma.LoanUpsertWithoutPaymentsInput> = z.strictObject({
  update: z.union([ z.lazy(() => LoanUpdateWithoutPaymentsInputSchema), z.lazy(() => LoanUncheckedUpdateWithoutPaymentsInputSchema) ]),
  create: z.union([ z.lazy(() => LoanCreateWithoutPaymentsInputSchema), z.lazy(() => LoanUncheckedCreateWithoutPaymentsInputSchema) ]),
  where: z.lazy(() => LoanWhereInputSchema).optional(),
});

export const LoanUpdateToOneWithWhereWithoutPaymentsInputSchema: z.ZodType<Prisma.LoanUpdateToOneWithWhereWithoutPaymentsInput> = z.strictObject({
  where: z.lazy(() => LoanWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LoanUpdateWithoutPaymentsInputSchema), z.lazy(() => LoanUncheckedUpdateWithoutPaymentsInputSchema) ]),
});

export const LoanUpdateWithoutPaymentsInputSchema: z.ZodType<Prisma.LoanUpdateWithoutPaymentsInput> = z.strictObject({
  id: z.union([ z.cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerEmail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerPhone: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const LoanUncheckedUpdateWithoutPaymentsInputSchema: z.ZodType<Prisma.LoanUncheckedUpdateWithoutPaymentsInput> = z.strictObject({
  id: z.union([ z.cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerEmail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  borrowerPhone: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const PaymentCreateManyLoanInputSchema: z.ZodType<Prisma.PaymentCreateManyLoanInput> = z.strictObject({
  id: z.cuid().optional(),
  amount: z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
  date: z.coerce.date().optional(),
  notes: z.string().optional().nullable(),
...
export const PaymentUpdateWithoutLoanInputSchema: z.ZodType<Prisma.PaymentUpdateWithoutLoanInput> = z.strictObject({
  id: z.union([ z.cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  amount: z.union([ z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  date: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  notes: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const PaymentUncheckedUpdateWithoutLoanInputSchema: z.ZodType<Prisma.PaymentUncheckedUpdateWithoutLoanInput> = z.strictObject({
  id: z.union([ z.cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  amount: z.union([ z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  date: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  notes: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const PaymentUncheckedUpdateManyWithoutLoanInputSchema: z.ZodType<Prisma.PaymentUncheckedUpdateManyWithoutLoanInput> = z.strictObject({
  id: z.union([ z.cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  amount: z.union([ z.union([z.number(),z.string(),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  date: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  notes: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const LoanFindFirstArgsSchema: z.ZodType<Prisma.LoanFindFirstArgs> = z.object({
  select: LoanSelectSchema.optional(),
  include: LoanIncludeSchema.optional(),
  where: LoanWhereInputSchema.optional(), 
  orderBy: z.union([ LoanOrderByWithRelationInputSchema.array(), LoanOrderByWithRelationInputSchema ]).optional(),
...
export const LoanFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LoanFindFirstOrThrowArgs> = z.object({
  select: LoanSelectSchema.optional(),
  include: LoanIncludeSchema.optional(),
  where: LoanWhereInputSchema.optional(), 
  orderBy: z.union([ LoanOrderByWithRelationInputSchema.array(), LoanOrderByWithRelationInputSchema ]).optional(),
...
export const LoanFindManyArgsSchema: z.ZodType<Prisma.LoanFindManyArgs> = z.object({
  select: LoanSelectSchema.optional(),
  include: LoanIncludeSchema.optional(),
  where: LoanWhereInputSchema.optional(), 
  orderBy: z.union([ LoanOrderByWithRelationInputSchema.array(), LoanOrderByWithRelationInputSchema ]).optional(),
...
export const LoanAggregateArgsSchema: z.ZodType<Prisma.LoanAggregateArgs> = z.object({
  where: LoanWhereInputSchema.optional(), 
  orderBy: z.union([ LoanOrderByWithRelationInputSchema.array(), LoanOrderByWithRelationInputSchema ]).optional(),
  cursor: LoanWhereUniqueInputSchema.optional(), 
  take: z.number().optional(),
...
export const LoanGroupByArgsSchema: z.ZodType<Prisma.LoanGroupByArgs> = z.object({
  where: LoanWhereInputSchema.optional(), 
  orderBy: z.union([ LoanOrderByWithAggregationInputSchema.array(), LoanOrderByWithAggregationInputSchema ]).optional(),
...
export const LoanFindUniqueArgsSchema: z.ZodType<Prisma.LoanFindUniqueArgs> = z.object({
  select: LoanSelectSchema.optional(),
  include: LoanIncludeSchema.optional(),
  where: LoanWhereUniqueInputSchema, 
}).strict();

export const LoanFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.LoanFindUniqueOrThrowArgs> = z.object({
  select: LoanSelectSchema.optional(),
  include: LoanIncludeSchema.optional(),
  where: LoanWhereUniqueInputSchema, 
}).strict();
...
export const LoanCreateArgsSchema: z.ZodType<Prisma.LoanCreateArgs> = z.object({
  select: LoanSelectSchema.optional(),
  include: LoanIncludeSchema.optional(),
  data: z.union([ LoanCreateInputSchema, LoanUncheckedCreateInputSchema ]),
}).strict();

export const LoanUpsertArgsSchema: z.ZodType<Prisma.LoanUpsertArgs> = z.object({
  select: LoanSelectSchema.optional(),
  include: LoanIncludeSchema.optional(),
  where: LoanWhereUniqueInputSchema, 
...
export const LoanCreateManyArgsSchema: z.ZodType<Prisma.LoanCreateManyArgs> = z.object({
  data: z.union([ LoanCreateManyInputSchema, LoanCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const LoanCreateManyAndReturnArgsSchema: z.ZodType<Prisma.LoanCreateManyAndReturnArgs> = z.object({
  data: z.union([ LoanCreateManyInputSchema, LoanCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const LoanDeleteArgsSchema: z.ZodType<Prisma.LoanDeleteArgs> = z.object({
  select: LoanSelectSchema.optional(),
  include: LoanIncludeSchema.optional(),
  where: LoanWhereUniqueInputSchema, 
}).strict();

export const LoanUpdateArgsSchema: z.ZodType<Prisma.LoanUpdateArgs> = z.object({
  select: LoanSelectSchema.optional(),
  include: LoanIncludeSchema.optional(),
...
export const LoanUpdateManyArgsSchema: z.ZodType<Prisma.LoanUpdateManyArgs> = z.object({
  data: z.union([ LoanUpdateManyMutationInputSchema, LoanUncheckedUpdateManyInputSchema ]),
  where: LoanWhereInputSchema.optional(), 
  limit: z.number().optional(),
}).strict();

export const LoanUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.LoanUpdateManyAndReturnArgs> = z.object({
  data: z.union([ LoanUpdateManyMutationInputSchema, LoanUncheckedUpdateManyInputSchema ]),
  where: LoanWhereInputSchema.optional(), 
  limit: z.number().optional(),
}).strict();

export const LoanDeleteManyArgsSchema: z.ZodType<Prisma.LoanDeleteManyArgs> = z.object({
  where: LoanWhereInputSchema.optional(), 
  limit: z.number().optional(),
}).strict();
